from dronekit import connect, time, LocationGlobalRelative
...
s.arm()
s.takeoff()
location = LocationGlobalRelative(lat=51.022745, lon=3.709940, alt=5)
vehicle.simple_goto(location=location, groundspeed=10)
time.sleep(15)
location = LocationGlobalRelative(lat=51.022622, lon=3.709873, alt=5)
vehicle.simple_goto(location=location, groundspeed=10)
time.sleep(15)
